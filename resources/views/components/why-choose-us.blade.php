<div>
    <center>
        <x-ui.heading title="Why Choose Us" subtitle="best in northeast" />
    </center>
    ...
    <div class="grid lg:grid-cols-3 grid-cols-1 gap-5 items-center mx-auto container mt-10 relative z-10">
        <div data-animate="fadeLeft" data-animate-delay="100"
            ...
            <div class="text-center  max-w-sm mx-auto w-full space-y-3">
                <h2 class=" text-2xl">All You Needs</h2>

                <p class="text-xs text-gray-600">
                    Complete travel services, from car rentals to accommodations!
                </p>
            </div>
        </div>
        ...
        <div data-animate="fadeUp" data-animate-delay="900"
            ...
            <div class="text-center  max-w-sm mx-auto w-full space-y-3">
                <h2 class=" text-2xl">Flexible Booking</h2>

                <p class="text-xs ">
                    Hassle-free reservations with easy changes and cancellations!
                </p>
            </div>
        </div>
